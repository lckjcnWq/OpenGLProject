...
class Main3Renderer : GLSurfaceView.Renderer {
    ...
    init {
        ...
        fragmentShader = ResourceUtils.readRaw2String(R.raw.simple_fragment3_shader)
        vertexShader = ResourceUtils.readRaw2String(R.raw.simple_vertex3_shader)
    }
